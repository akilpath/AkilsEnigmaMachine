...
int letterCiphered;//stores the letter value of the new ciphered letter
...
void keyPressed() {
  ...
  if (!keyBeingPressed) {
    ...
    if ((key > 64 && key < 91) || (key > 96 && key < 123 )) {
      ...
      letterCiphered = letter.cipherLetter(key);
...
void keyReleased() {
  //resets key colours
  if ((key > 64 && key < 91) || (key > 96 && key < 123 )) {
    buttonPressed[letter.getCharInt(key)] = 255;
    keyLitUp[letterCiphered] = 255;
  }

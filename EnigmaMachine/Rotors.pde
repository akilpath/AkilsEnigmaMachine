class Rotors {
  ...
  /*
   ...
   rotorOneWiring        = "JGDQOXUSCAMIFRVTPNEWKBLZYH";
   rotorTwoWiring        = "NTZPSFBOKMWRCJDIVLAEYUXHGQ";
   rotorThreeWiring      = "JVIUBHTCDYAKEQZPOSGXNRMWFL";
   reflectorWiringString = "QYHOGNECVPUZTFDJAXWMKISRBL";
